...
export const GAMES = [
  ...
  },
  {
    ...
    name: "Backgammon",
    slug: "backgammon",
    line: "Race the dice home — hit, hold the bar, and bear off first.",
    measure: "rounds",
    outcomes: true,
    online: true,
    seats: 2,
...
// The games that can be played against another person in a room. The lobby
// needs this on the client, where lib/rooms.js cannot go.
export const ONLINE = GAMES.filter((g) => g.online);
