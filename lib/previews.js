...
// A hand part way through: a set of threes, a four-card run, and sixteen points
// of deadwood still to lose.
export const RUMMY_PREVIEW = {
  hand: [6, 7, 8, 9, 15, 24, 28, 30, 39, 41],
  discard: [18],
  theirs: 10,
  stock: 24,
};
