...
// A table part way through: two melds down, a rack still holding a joker.
export const REMI_PREVIEW = {
  table: [
    { seat: "a", tiles: [17, 18, 19] },
    { seat: "b", tiles: [3, 16, 42] },
  ],
  hand: [10, 11, 24, 25, 26, 38, 51, 60, 73, 86, 99, 104],
  others: { b: 11, c: 13 },
  names: { b: "Machine one", c: "Machine two" },
  discard: [45],
  stock: 41,
};
