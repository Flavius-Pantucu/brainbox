...
const CHALLENGES = {
  ...
  remi: [
    "Open on the very first turn you can.",
    "Go out with a joker still on the table.",
    "Win a game without ever finishing a hand above thirty.",
  ],
  backgammon: [
    "Win a game without ever sitting on the bar.",
    "Bear off before the machine bears off one checker.",
    "Win a game where you were behind on pips at the halfway point.",
  ],
  minesweeper: [
